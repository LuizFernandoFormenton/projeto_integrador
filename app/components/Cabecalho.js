...
function Cabecalho () {
    ...
    <main>
        <BarraLateral/>
        <div style={{ background: "linear-gradient(to right, white, #e5e5e5)"}} className="flex h-20 w-full items-center fixed gap-20 px-8 text-[13px] z-50">
        ...
        <label>
            <input className=" h-[64px] border-none p-2 w-[250px] bg-gray-300" type="text" placeholder="🔍 O que você está procurando?" 
